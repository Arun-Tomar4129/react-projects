...
">
      {/* Profile Banner */}
      <div className="w-full bg-blue-200 rounded-l-full flex items-center shadow-md p-4">
 ...
 <div className=" p-4 rounded-md flex justify-center gap-4 flex-wrap">
      ...
      <div className=" p-4 rounded-md  shadow-md">
        ...
        <ul className="flex justify-center gap-x-19">
          {[
            {
            ...
            <li
              key={i}
              className="size-[90px] hover:scale-110 transition-transform duration-200"
            >
